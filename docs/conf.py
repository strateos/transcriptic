...
sys.path.insert(0, os.path.abspath("../transcriptic/analysis"))
...
html_short_title = "TxPy Docs"

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = "_static/transcriptic.svg"
...
latex_documents = [
    (
        "index",
        "transcriptic.tex",
        u"transcriptic Documentation",
        u"Max Hodak, Tali Herzka, Jeremy Apthorp, Yang Choo, Peter Lee",
        "manual",
    ),
]
